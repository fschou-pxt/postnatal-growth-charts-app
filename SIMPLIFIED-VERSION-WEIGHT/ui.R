...
shinyUI(
    fixedPage(style="margin-top:25px;padding-top:25px;border-left:1px solid #eeeeee;border-top:1px solid #eeeeee;border-right:1px solid #cccccc;border-bottom:1px solid #888888;",
        ...
        fluidRow(style="font-size:16px;margin:0;",
                 div(class="col-lg-12 col-md-12 col-sm-12", strong(tags$u("Weight Trajectory", style="font-size:24px;")), hr()),
        ...
        fluidRow(style="font-size:12px;margin:0;",
                 ...
                 div(class="col-lg-7 col-md-7 col-sm-7",
                     plotOutput("weight_plot", height = "410px")
                 )
        ),
        fluidRow(style="font-size:16px;margin:0;border:2px solid #546E7A;padding:6px 5px 0 5px;border-radius:5px;",
                 div(class="col-lg-3 col-md-5 col-sm-5", textInput("enterTP", "Enter Trajectory Percentile:", width = "100%")),
                 div(class="col-lg-9 col-md-7 col-sm-7", uiOutput("rate"))),
